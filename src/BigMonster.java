...
public class BigMonster extends Monster{
    ...
    public boolean taskMonster(int difficultGame){
        ...
        if (difficultGame == 1){
            ...
            System.out.println("Пример: " + x + " * " + y + " - " + z + " = ?");
            Scanner sc = new Scanner(System.in);
            int ans = sc.nextInt();
            if (trueAnswer == ans) {
                System.out.println("УУУ крассавчик, победил сильного противника");
                return true;
            }
            System.out.println("Ну на другое я и не ожидал");
            return false;
        }
